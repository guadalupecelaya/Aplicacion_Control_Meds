...
public class MedidasEliminar extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(MedidasEliminar.this, "Error al actualizar medicamento", Toast.LENGTH_SHORT).show();
    ...
    private void eliminarMedicamento(){
        ...
        startActivity(new Intent(MedidasEliminar.this, MainActivity.class));
        finish();
